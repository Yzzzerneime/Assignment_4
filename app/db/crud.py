...
def update_category(db: Session, category_id: int, new_title: str) -> models.Category | None:
...
def create_book(db: Session, title: str, description: str, price: float,
                category_id: int, url: str = "") -> models.Book:
    db_book = models.Book(
        title=title,
...
def update_book(db: Session, book_id: int, **kwargs) -> models.Book | None:
